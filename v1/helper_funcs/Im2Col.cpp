...
Tensor<float, 2> Im2Col::im2col(const Tensor<float, 4>& X, int k_height, int k_width, int padding = 1, int stride = 1) {
    //  X shape: [N, C, H, W]
...
Tensor<float, 4> Im2Col::im2col_bw(Tensor<float, 2>& grad_X_col, Eigen::array<int, 4>& X_shape,
